<?php
  ...
  // データの更新処理（更新ボタンクリック時）
  if (!empty($_POST)) {
    $sql = 'UPDATE `friends` SET `friend_name`=?,`area_id`=?,`gender`=?,`age`=? WHERE `freind_id` = ?';
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 content-margin-top">
        <legend>友達の編集</legend>
        <form method="post" action="edit.php?friend_id=<?php echo $friends['freind_id']; ?>" class="form-horizontal" role="form">
            <!-- 名前 -->
